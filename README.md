...
## zsh
I use zsh as my shell and use [ohmyzsh](https://ohmyz.sh/) to manage my configs. I also use [kitty](https://sw.kovidgoyal.net/kitty/) as my terminal emulator. It is a fast lightweight terminal emulator with a builtin tmux-like feature I strongly recommend!
